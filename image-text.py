...
# Hmmm. There are A LOT OF WARNINGS.  Above did not get rid of them?
...
question = (
    f"{DEFAULT_IMAGE_TOKEN} This is the first image. Can you describe what you see?"
